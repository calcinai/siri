...
/**
 * Class representing EstimatedTimetableCapabilityRequestPolicyStructureType
 *
 * Type for Estimated Timetable Capability Request Policy
 * XSD Type: EstimatedTimetableCapabilityRequestPolicyStructure
 */
class EstimatedTimetableCapabilityRequestPolicyStructureType extends CapabilityRequestPolicyStructureType
{
