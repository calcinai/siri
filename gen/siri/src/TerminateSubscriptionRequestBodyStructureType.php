...
/**
 * Class representing TerminateSubscriptionRequestBodyStructureType
 *
 * Type for Body of Terminate Subscription Request content. Used in WSDL.
 * XSD Type: TerminateSubscriptionRequestBodyStructure
 */
class TerminateSubscriptionRequestBodyStructureType
{
