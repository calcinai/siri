 ...
 * XSD Type: AccessibilityLimitationStructure
 */
class AccessibilityLimitationStructureType
{

    /**
     * Unique identifier of Hazard.
     *
     * @property string $limitationId
     */
    private $limitationId = null;
     ...
     * @return self
     */
    public function setLimitationId($limitationId)
    {
