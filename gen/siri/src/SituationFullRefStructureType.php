...
/**
 * Class representing SituationFullRefStructureType
 *
 * Type for Reference to a Situation.
 * XSD Type: SituationFullRefStructure
 */
class SituationFullRefStructureType
{
     ...
     *
     * @property string $versionCountryRef
     */
    private $versionCountryRef = null;
    ...
    /**
     * Gets as versionCountryRef
     *
     * Unique identifier of a Country of a Participant who created Update Situation element . Provides namespace for VersionParticipant If absent same as
     *
     * @return string
     */
    public function getVersionCountryRef()
    {
        return $this->versionCountryRef;
    }

    /**
     * Sets a new versionCountryRef
     *
     * Unique identifier of a Country of a Participant who created Update Situation element . Provides namespace for VersionParticipant If absent same as
     *
     * @param string $versionCountryRef
     * @return self
     */
    public function setVersionCountryRef($versionCountryRef)
    {
        $this->versionCountryRef = $versionCountryRef;
        return $this;
    }
