...
/**
 * Class representing DataSupplyRequestStructureType
 *
 * Type for Data supply Request
 * XSD Type: DataSupplyRequestStructure
 */
class DataSupplyRequestStructureType extends ConsumerRequestEndpointStructureType
{
