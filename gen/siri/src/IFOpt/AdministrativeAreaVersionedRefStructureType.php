...
/**
 * Class representing AdministrativeAreaVersionedRefStructureType
 *
 * Type for a versioned reference to an administrative area.
 * XSD Type: AdministrativeAreaVersionedRefStructure
 */
class AdministrativeAreaVersionedRefStructureType
{
