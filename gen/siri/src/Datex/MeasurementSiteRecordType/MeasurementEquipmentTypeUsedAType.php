...
class MeasurementEquipmentTypeUsedAType
{
    ...
    /**
     * @property \Calcinai\Siri\Datex\MeasurementSiteRecordType\MeasurementEquipmentTypeUsedAType\ValueAType[] $value
     */
    private $value = [
     ...
     */
    public function addToValue(\Calcinai\Siri\Datex\MeasurementSiteRecordType\MeasurementEquipmentTypeUsedAType\ValueAType $value)
    {
        $this->value[] = $value;
        return $this;
    }
